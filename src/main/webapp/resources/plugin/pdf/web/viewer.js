...
function getPDFUrl() {
    ...
    var limit = "?pdfUrl=";
    var limit2 = "resources/plugin/pdf/";
    var baseUrl = curUrl.substring(0,curUrl.indexOf(limit2));
    var pdfUrl = curUrl.substring(curUrl.indexOf(limit)+limit.length);
    return baseUrl + pdfUrl;
}
var DEFAULT_URL = getPDFUrl();
